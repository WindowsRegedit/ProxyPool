...
ENABLE_VERIFY = env.bool('ENABLE_VERIFY', True)
...
TEST_URL = env.str('TEST_URL', 'http://google.cn/generate_204')
...
# })
TEST_VALID_STATUS = env.list('TEST_VALID_STATUS', [200, 206, 302, 204])
